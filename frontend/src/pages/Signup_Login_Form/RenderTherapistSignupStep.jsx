        ...
        case 1:
            return (
                <>
                    ...
                    <div className="input-field">
                        <i><FaKey /></i>
                        <input type="password" placeholder="Passwor" value={password} onChange={(e) => setPassword(e.target.value)} />
                    </div>
                    <div className="buttons">
                        <button className="btn1 hover-visible" type="button" onClick={handleNextStep}>Next</button>
                    </div>
                </>
            );
        case 2:
            ...
            <div className="buttons">
              <button className="btn1 hover-visible" type="button" onClick={handlePrevStep}>Back</button>
              <button className="btn1 hover-visible" type="button" onClick={handleNextStep}>Next</button>
            </div>
                </>
            );
        ...
        case 8:
            return (
                <>
                    ...
                    <div className="input-field">
                    <i><MdCastForEducation /></i>
                        <input className='input-field' type="file" placeholder="Education Certificate" onChange={(e) => setEducationCertificate(e.target.files[0])} />
                    </div>
                    <div className="input-field">
                    <i><TbLicense /></i>
                        <input className='input-field' type="file" placeholder="License" onChange={(e) => setLicense(e.target.files[0])} />
                    </div>
                    <div className="buttons">
                        <button className="btn1 hover-visible" type="button" onClick={handlePrevStep}>Back</button>
                        <button className="btn1 hover-visible" type="submit" onClick={handleTherapistRegistration}>Register</button>
                    </div>
                </>
            );
        default:
